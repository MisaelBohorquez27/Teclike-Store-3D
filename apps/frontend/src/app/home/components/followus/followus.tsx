      ...
      <div className="relative z-10 py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-3 gap-8 md:gap-12">
            ...
            >
              {/* Newsletter Section
              <div className="p-6 rounded-3xl bg-linear-to-br from-gray-900/80 to-black/80 backdrop-blur-md border border-gray-800/50">
                  ...
                  {[
                    ...
                    <div key={index} className="p-3 rounded-xl bg-gray-800/30">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="w-6 h-6 rounded-full bg-linear-to-r from-cyan-500 to-blue-500" />
