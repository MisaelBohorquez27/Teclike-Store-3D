          ...
          <div className="container mx-auto px-4 h-full">
            <div className="flex flex-col lg:flex-row items-center justify-between h-full gap-8 py-8 md:py-16 lg:py-20">
              ...
              >
                {/* Badge de featured */}
                <motion.div
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/20 text-primary text-sm font-medium mb-6"
                ...
                {/* Subtítulo mejorado */}
                <motion.p
                  className="text-neutral text-xl md:text-2xl mb-8 leading-relaxed max-w-lg"
                ...
                >
                  ...
                  <div className="flex items-center gap-3 p-3 rounded-2xl bg-white/50 dark:bg-neutral-4/50 backdrop-blur-sm border border-white/20">
                    ...
                    <span className="text-sm font-semibold text-neutral-1 dark:text-neutral-2">
                      2K+ Ventas
                    </span>
                  </div>
                ...
                >
                  ...
                  <p className="text-sm text-neutral dark:text-neutral-3">
                    <span className="font-semibold text-neutral-1 dark:text-neutral-2">
                      +2,500
                    </span>{" "}
                ...
                <div className="relative">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-sm font-semibold text-neutral-1 dark:text-neutral-2">
                          Render 4K
                        </div>
                        <div className="text-xs text-neutral-2 dark:text-neutral-3">
                          Tiempo real
                        </div>
                      </div>
                    </div>
