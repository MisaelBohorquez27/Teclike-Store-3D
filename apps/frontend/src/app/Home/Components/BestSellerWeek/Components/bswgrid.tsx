...
const Header = () => (
  ...
  >
    ...
    <Link href="/Products">
      <Button className="group inline-flex items-center gap-3 px-6 py-3 rounded-xl bg-gradient-to-r from-gray-900 to-black hover:from-gray-800 hover:to-gray-900 border border-gray-800 hover:border-amber-500/30 text-white font-medium transition-all duration-300 hover:scale-105">
