...
CREATE TABLE "public"."offers" (
    ...
    "recurrence" "public"."OfferRecurrence" NOT NULL DEFAULT 'NONE',
...
-- CreateTable
CREATE TABLE "public"."image_products" (
    "id" SERIAL NOT NULL,
    "productId" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "public"."image_products" ADD CONSTRAINT "image_products_productId_fkey" FOREIGN KEY ("productId") REFERENCES "public"."products"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
